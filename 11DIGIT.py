...
def menu():
    ...
    print 'AUTHOR   : PASHI ALAM'

    print 'FACEBOOK : https://www.facebook.com/pashi.alom'

    print 'GITHUB     : github.com/PASHI'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Pashi-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[Pashi-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
    ...
    os.system('python2 11DIGIT.py')

if __name__ == '__main__':

    menu()

# okay decompiling UF11.pycimport os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
